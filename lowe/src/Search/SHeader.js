    ...
    render() {
        return (
            <header className="header3">
                ...
                <span>
                    <input id="header_search" onChange={this.props.handleInputValue("search")} onKeyPress={this.props.onclickEnter} className="header_input" placeholder="검색어를 입력해주세요" type="text"></input>
                </span>
                    <span >
